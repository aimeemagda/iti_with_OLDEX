function tree = quick_load_mat_passed(tree,data,classes)
%quick insert data into top node of tree (here ==1)
%data is passed directly into function (as opposed to 'quick_load_mat.m')
...
for i=1:n_variables
    ...
    %tree(1).variables(i).variable_key = 
end
