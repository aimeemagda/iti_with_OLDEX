function tree = kernel_quick_load_mat_passed(kernel_type,kernel_transform_table,kernel_transform_table_ix,tree,data,classes)
...
%get overall list of unique values
for i=1:n_variables
...
for i=1:n_classes  %for each class
    class1 = strcmp(classes,all_classes{i});  %occurences of this class
    class_totals(i) = sum(class1);  %count of occurences of this class
    data_class1 = data(class1,:);   %data for current class
    data_class1_ix = ix(class1,:);  %indices of this class in full list
    this_class_nvc = cell(1,n_variables); %this class's numeric value counts
    this_class_cc = cell(1,n_variables);  %this class's class counts
    this_class_cct = cell(1,n_variables); %this class's class count tags
    for j=1:n_variables
